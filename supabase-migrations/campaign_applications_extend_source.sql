...
ALTER TABLE campaign_applications
  ...
  CHECK (target_source IN (
    'lba', 'internal', 'manual',
    'adzuna', 'lba_v1', 'lba_v3', 'france_travail', 'other'
  ));

-- Valeur par défaut reste 'lba' pour compatibilité
COMMENT ON COLUMN campaign_applications.target_source IS 'Source de l''offre: lba, adzuna, lba_v1, lba_v3, france_travail, other, internal, manual';
