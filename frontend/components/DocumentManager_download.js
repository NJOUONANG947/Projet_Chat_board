    ...
    <div className="document-manager max-w-6xl mx-auto p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">
          Uploadez vos CV et offres d'emploi pour générer des lettres de motivation personnalisées
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="mb-4 p-2 bg-blue-50 rounded-lg">
              ...
              {selectedDocuments.length > 0 && (
                <button
                  ...
                  disabled={analyzing}
                  className="mt-2 w-full px-3 py-1 bg-blue-600 text-white rounded-md hover:bg-blue-700 disabled:opacity-50 text-sm"
                >
                  {analyzing ? 'Génération...' : 'Générer la lettre de motivation'}
                </button>
              )}
            </div>
            {loading ? (
        ...
        <div className="lg:col-span-1">
          <motion.div
            ...
            className="bg-white rounded-lg shadow-lg p-6"
          >
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Lettre de motivation générée</h2>
            {analyzing ? (
              <div className="text-center py-8">
                <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600 mx-auto"></div>
              ...
              <p className="text-gray-600">Cliquez sur "Générer la lettre de motivation" pour créer une lettre personnalisée.</p>
            ) : (
              <p className="text-gray-600">Sélectionnez un ou plusieurs documents pour générer une lettre de motivation.</p>
            )}
          </motion.div>
        </div>
      </div>
